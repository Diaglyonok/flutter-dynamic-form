 ...
 *
 * Locales: 2
 * Strings: 482 (241.0 per locale)
 *
 * Built on 2022-05-12 at 20:32 UTC
 */
...
class LocaleSettings {
  ...
  static List<String> get supportedLocalesRaw {
    return DynamicFormAppLocale.values.map((locale) => locale.languageTag).toList();
  }

  /// Gets supported locales (as Locale objects) with base locale sorted first.
  static List<Locale> get supportedLocales {
    return DynamicFormAppLocale.values.map((locale) => locale.flutterLocale).toList();
  }
}
...
extension DynamicFormAppLocaleExtensions on DynamicFormAppLocale {
  ...
  _DynamicFormLocalizationsEn get translations {
    switch (this) {
      case DynamicFormAppLocale.en:
        return _translationsEn;
      case DynamicFormAppLocale.ru:
  ...
  _DynamicFormLocalizationsEn build() {
    switch (this) {
      case DynamicFormAppLocale.en:
        return _DynamicFormLocalizationsEn.build();
      case DynamicFormAppLocale.ru:
        return _DynamicFormLocalizationsRu.build();
    }
  }
...
extension StringDynamicFormAppLocaleExtensions on String {
  DynamicFormAppLocale? toDynamicFormAppLocale() {
    switch (this) {
      case 'en':
        return DynamicFormAppLocale.en;
      case 'ru':
        return DynamicFormAppLocale.ru;
      default:
        return null;
    }
  }
...
DynamicFormAppLocale? _selectLocale(String localeRaw) {
  ...
  if (match != null) {
    ...
    // match exactly
    selected = DynamicFormAppLocale.values.cast<DynamicFormAppLocale?>().firstWhere(
...
class _DynamicFormLocalizationsEn {
  ...
  String passwordErrorText({required Object MIN, required Object MAX}) =>
      'Your password must be between $MIN and $MAX characters and contain at least one number and one letter';
  String useridErrorText({required Object MIN}) =>
  ...
  String get nothingFoundCountryCode =>
      'Nothing found, try changing your query or entering the country code manually';
}
...
class _DynamicFormLocalizationsRu implements _DynamicFormLocalizationsEn {
  ...
  @override
  late final _DynamicFormLocalizationsRu _root = this; // ignore: unused_field
  ...
  @override
  String passwordErrorText({required Object MIN, required Object MAX}) =>
      'Пароль должен быть в пределах от $MIN до $MAX символов и содержать как минимум одну букву и одну цифру';
  @override
  ...
  @override
  String get chooseCountryCode => 'Выберите или введите код страны';
  @override
  String get useInputtedCode => 'Использовать введенный код';
  @override
  String get nothingFoundCountryCode =>
...
extension on _DynamicFormLocalizationsEn {
  Map<String, dynamic> _buildFlatMap() {
    return <String, dynamic>{
      ...
      'passwordErrorText': ({required Object MIN, required Object MAX}) =>
          'Your password must be between $MIN and $MAX characters and contain at least one number and one letter',
      'useridErrorText': ({required Object MIN}) =>
          'Login length should be greater than $MIN characters',
